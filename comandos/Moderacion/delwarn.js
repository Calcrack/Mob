...
if(!permiso)return message.channel.send("No tienes suficientes permisos!")
  ...
  if(!member) return message.channel.send("Necesitas mencionar a alguien para quitar su warn <:No:925269844197269534>")
  ...
  warns.restar(`${message.guild.id}.${member.id}`, 1)
  ...
  .setDescription(`Se ha eliminado un warn del usuario:\n${member}`)
  .setColor("RED")
